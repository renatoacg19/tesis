...
from core.home.models import factura
...
class FacturaListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('home:factura_create')
        context['list_url'] = reverse_lazy('home:factura_list')
...
class FacturasCreateView(CreateView):
    ...
    success_url = reverse_lazy('home:factura_list')
...
class FacturaUpdateView(UpdateView):
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context['title'] = 'Edición de una Factura'
        context['entity'] = 'Factura'
        context['list_url'] = self.success_url
        context['action'] = 'edit'
        return context
