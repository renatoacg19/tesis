...
from core.home.models import productos
...
class ProductosListView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['create_url'] = reverse_lazy('home:productos_create')
        context['list_url'] = reverse_lazy('home:productos_list')
...
class ProductosCreateView(CreateView):
    ...
    success_url = reverse_lazy('home:productos_list')
